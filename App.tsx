             ...
             <div className="flex flex-wrap gap-x-8 gap-y-6 items-end">
               ...
               <div className="flex flex-col">
                 ...
                 <div className="relative group">
                   <select 
                     className="bg-white border-2 border-emerald-100 rounded-2xl px-5 py-3 text-sm font-black text-slate-700 outline-none focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-600 transition-all shadow-sm min-w-[220px] appearance-none"
                     value={selectedSede}
               ...
               <div className="flex flex-col">
                 ...
                 <div className="relative group">
                   <select 
                     className="bg-white border-2 border-slate-200 rounded-2xl px-5 py-3 text-sm font-black text-slate-700 outline-none focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-600 transition-all shadow-sm min-w-[200px] appearance-none"
